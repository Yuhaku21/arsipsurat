...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "INSERT INTO tb_sm (no_surat, tgl_masuk, pengirim, perihal, tgl_arsip, id_instansi, id_status_arsip) VALUES ('$no_surat', '$tgl_masuk', '$pengirim', '$perihal', '$tgl_arsip', '$id_instansi', '$id_status_arsip')";

    if (mysqli_query($koneksi, $query)) {
        // Jika berhasil, redirect ke halaman surat masuk
