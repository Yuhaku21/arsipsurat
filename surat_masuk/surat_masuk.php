...
<body>
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                <div class="mb-3">
                    <h2 class="main-title">Data Surat Masuk</h2>
                ...
                <!-- Button to Add Data -->
                <div class="mb-3">
                    <a href="tambah_data_sm.php" class="btn btn-primary">
                ...
                <div class="table-responsive">
                    <table id="suratMasukTable" class="table table-striped table-bordered display">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                echo "<tr>
                                        ...
                                        <td>
                                            <a href='edit_sm.php?id_sm={$row['id_sm']}' class='btn btn-warning btn-sm'><i class='fas fa-edit'></i> Edit</a>
                                            <a href='proses_hapus_sm.php?id_sm={$row['id_sm']}' class='btn btn-danger btn-sm' onclick=\"return confirm('Apakah Anda yakin ingin menghapus data ini?');\">
    ...
    $(document).ready(function() {
        $('#suratMasukTable').DataTable(); // Initialize DataTables
    });
    </script>
</body>
