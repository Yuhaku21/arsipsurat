...
<body>
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                <div class="mb-3">
                    <h2 class="main-title">Data Instansi</h2>
                ...
                <!-- Button to Add Data -->
                <div class="mb-3">
                    <a href="tambah_data_instansi.php" class="btn btn-primary">
                ...
                <div class="table-responsive">
                    <table id="instansiTable" class="table table-striped table-bordered display">
                        <thead>
                            <tr>
                                <th>ID Instansi</th>
                                <th>Nama Instansi</th>
                        ...
                        <tbody>
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                echo "<tr>
                                        ...
                                        <td>{$row['kepala_instansi']}</td>
                                        <td>
                                            <a href='edit_instansi.php?id_instansi={$row['id_instansi']}' class='btn btn-warning btn-sm'><i class='fas fa-edit'></i> Edit</a>
                                            <a href='proses_hapus_instansi.php?id_instansi={$row['id_instansi']}' class='btn btn-danger btn-sm' onclick=\"return confirm('Apakah Anda yakin ingin menghapus data ini?');\">
    ...
    $(document).ready(function() {
        $('#instansiTable').DataTable(); // Initialize DataTables
    });
    </script>
</body>
