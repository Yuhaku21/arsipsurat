...
$query = "SELECT * FROM tb_user"; // Assuming your table is named 'users'
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                <div class="mb-3">
                    <h2 class="main-title">Data User</h2>
                ...
                <!-- Button to Add Data -->
                <div class="mb-3">
                    <a href="tambah_data_user.php" class="btn btn-primary">
                        ...
                        <tbody>
                            ...
                            while ($row = mysqli_fetch_assoc($result)) {
                                echo "<tr>
                                        ...
                                        <td>{$row['level']}</td>
                                        <td>
                                            <a href='edit_user.php?id_user={$row['id_user']}' class='btn btn-warning btn-sm'><i class='fas fa-edit'></i> Edit</a>
                                            <a href='proses_hapus_user.php?id_user={$row['id_user']}' class='btn btn-danger btn-sm' onclick=\"return confirm('Apakah Anda yakin ingin menghapus data ini?');\">
