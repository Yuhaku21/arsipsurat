...
<head>
    ...
    <title>Dashboard Admin - Sistem Informasi Pengarsipan</title>
    <meta name="description" content="Dashboard admin untuk sistem informasi pengarsipan surat masuk dan keluar.">
        ...
        <div class="row">
            ...
            <nav class="col-md-3 col-lg-2 sidebar p-3">
                ...
                <div class="profile text-center mb-3">
                    <img src="img/foto.png" alt="Foto Admin Istiyana">
                ...
                <ul class="nav flex-column mt-3">
                    <ul class="nav flex-column mt-3">
                                ...
                                <ul class="nav flex-column ml-3">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="surat_masuk/surat_masuk.php"
                                            aria-label="Surat Masuk"><i class="fas fa-envelope"></i> Data Surat
                                            Masuk</a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="efektivitas/efektivitas.php"
                                            aria-label="Efektivitas"><i class="fas fa-chart-line"></i> Data
                                            Efektivitas</a>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <ul class="nav flex-column ml-3">
                                    <li class="nav-item">
                                        <a class="nav-link" href="views/laporan_rekapitulasi.php"
                                            aria-label="Laporan Rekapitulasi"><i class="fas fa-file-invoice"></i>
                                            Laporan
                                            Rekapitulasi</a>
                                    </li>
                                    <li class="nav-item">
                        ...
                        <li class="nav-item mt-4">
                            <a class="nav-link text-danger" href="index.php" aria-label="Keluar"><i
                    ...
                    <div class="mt-auto text-left">
                        <a href="index.php" class="btn btn-outline-light btn-sm"><i class="fas fa-arrow-left"></i></a>
                    </div>
            </nav>
            ...
            <main class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                <div class="mb-3">
                    ...
                    <p class="sub-title">Sistem Informasi Pengarsipan Surat Masuk dan Keluar</p>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card mb-4 shadow-sm card-menu">
                            <div class="card-body">
                                <a href="user/user.php" class="text-dark" aria-label="User"><i class="fas fa-user"></i>
                                    Data User</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card mb-4 shadow-sm card-menu">
                            <div class="card-body">
                                <a href="staff/staff.php" class="text-dark" aria-label="Staff"><i
                                        class="fas fa-users"></i>
                                    Data Staff</a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 shadow-sm card-menu">
                            <div class="card-body
                                                        <div class=" card-body">
                                <a href="surat_masuk/surat_masuk.php" class="text-dark" aria-label="Surat Masuk"><i
                                        class="fas fa-envelope"></i> Data Surat Masuk</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card mb-4 shadow-sm card-menu">
                            <div class="card-body">
                                <a href="surat_keluar/surat_keluar.php" class="text-dark" aria-label="Surat Keluar"><i
                                        class="fas fa-paper-plane"></i> Data Surat Keluar</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card mb-4 shadow-sm card-menu">
                            <div class="card-body">
                                <a href="instansi/instansi.php" class="text-dark" aria-label="Instansi"><i
                                        class="fas fa-building"></i> Data Instansi</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card mb-4 shadow-sm card-menu">
                            <div class="card-body">
                                <a href="status_pengarsipan/status_pengarsipan.php" class="text-dark"
                                    aria-label="Status Pengarsipan"><i class="fas fa-archive"></i> Data Status
                                    Pengarsipan</a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 shadow-sm card-menu">
                            <div class="card-body">
                                <a href="efektivitas/efektivitas.php" class="text-dark" aria-label="Efektivitas"><i
                                        class="fas fa-chart-line"></i> Data Efektivitas</a>
                            </div>
                        </div>
                    </div>
                </div>
